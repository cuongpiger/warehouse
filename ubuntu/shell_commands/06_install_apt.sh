...
sudo apt -y install libfuse2 goldendict install default-jre default-jdk flameshot virtualbox vagrant vlc python3-pip terminator tmux gedit-plugins mlocate gettext podman htop protobuf-compiler
